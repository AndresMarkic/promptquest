...
const DIC := {
	...
	"CERT_TITULO": {"es": "CERTIFICADO", "en": "CERTIFICATE"},
	"CERT_RANGO": {"es": "INGENIERO DE IA", "en": "AI ENGINEER"},
	"CERT_TEXTO": {"es": "Completaste las 8 zonas del Mundo Digital y dominás la IA de cero a experto.", "en": "You completed the 8 zones of the Digital World and mastered AI from zero to expert."},
	"CERT_SUB": {"es": "Otorgado por PromptQuest", "en": "Awarded by PromptQuest"},
	"CERT_XP": {"es": "%d XP de sabiduría", "en": "%d XP of wisdom"},
